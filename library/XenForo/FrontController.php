...
class XenForo_FrontController
{
	...
	*/
	protected function _handleControllerResponse($controllerResponse, $controllerName, $action)
	{
		...
		else if ($controllerResponse instanceof XenForo_ControllerResponse_ReroutePath)
		{
			if (!$controllerResponse->path)
			{
				throw new XenForo_Exception("Cannot reroute to path '{$controllerResponse->path}''");
			}
	...
	*/
	...
	public function renderDebugOutput($originalContent)
	{
		...
		return XenForo_Debug::getDebugPageWrapperHtml(
