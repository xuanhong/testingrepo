	...
	*/
	...
	protected function _postSave()
	{
		...
		if ($this->isInsert() || $generalPermissions !== null || $extraGroupIds !== null)
		{
			...
			if (!$generalModerator)
			{
				...
				$globalDw->setOption(
					XenForo_DataWriter_Moderator::OPTION_SET_IS_STAFF,
					$this->getOption(self::OPTION_SET_IS_STAFF)
				);
	...
	protected function _postDelete()
	{
		...
		)
		{
			...
			if ($this->getOption(self::OPTION_SET_IS_STAFF))
			{
				$dw->setOption(XenForo_DataWriter_Moderator::OPTION_SET_IS_STAFF, true);
			}
	...
	protected function _updatePermissions($newPermissions, $existingPermissions)
	{
		...
		$permissionModel->clearContentPermissionTypeHandlers();
