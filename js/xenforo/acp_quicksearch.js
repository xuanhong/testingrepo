...
d.find("li:first").addClass("kbSelect"))})},250)):a==""&&d.empty()},keydown:function(a){switch(a.which){case 38:case 40:var b=d.find("li"),c=b.filter(".kbSelect"),e=0;if(c.length&&(e=b.index(c.get(0)),e+=a.which==40?1:-1,e<0||e>=b.length))e=0;b.removeClass("kbSelect").eq(e).addClass("kbSelect");return!1}}});b.closest("form").submit(function(a){a.preventDefault();a=d.find("li.kbSelect a");if(a.length)j.location=a.attr("href");return!1})};XenForo.register("#AdminSearchForm","XenForo.AdminSearchForm")})(jQuery,
this,document);
